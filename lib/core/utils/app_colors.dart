...
class AppColors {
  static const Color primaryColor = Color(0xff4E5AE8); //shade of blue color
  //
  static const Color warmOrange = Color(0xffFF8746);
  static const Color pinkishRed = Color(0xffFF4667);
  //
